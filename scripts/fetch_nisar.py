"""Download NISAR browse (quicklook) PNGs for case-01 from ASF and save granule metadata."""
import json
import os
...
CASE_DIR = os.path.join("data", "processed", "case-01-earthquake")

GRANULES = {
    "before.png": "NISAR_L2_PR_GCOV_023_054_D_083_4005_DHDH_A_20260617T230235_20260617T230310_P05023_N_F_J_001",
    "after.png": "NISAR_L2_PR_GCOV_024_054_D_083_4005_DHDH_A_20260629T230235_20260629T230309_P05023_N_F_J_001",
}


def download_browse_image(granule_id, output_filename):
    """Download the browse image of one granule. Returns a metadata dict, or None on failure."""
    ...
    browse_urls = props.get("browse") or []  # 'or []' also handles a None value
    if not browse_urls:
    ...
    return {
        ...
        "browse_url": img_url,
        "footprint": product.geometry,  # GeoJSON, use it to check the epicenter is covered
    }


def fetch_case_01():
    os.makedirs(CASE_DIR, exist_ok=True)
    print("Fetching NISAR browse images for the Venezuela earthquake case...\n")
